...
For CCM to be a test of causality, two criteria must be met:
1) The cross map prediction skill is statistically significant using the full time series as the library.
2) Cross map prediction demonstrates convergence (i.e., prediction skill increases with the size of the library)
